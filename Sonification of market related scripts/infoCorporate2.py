...
def plot_candlestick_with_info(ticker, period):
    ...
    # Créer la grille de 3 zones : chandelier, volume, texte
    ...
    # Tracer chandeliers + volume avec les bons axes
    mpf.plot(hist, type='candle', ax=ax_candle, volume=ax_volume, style='yahoo')

    # Texte
    ax_text.text(
        0.02, 0.95, combined_text,
