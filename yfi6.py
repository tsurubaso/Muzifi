...
def assign_instrument(info):
    user_choice = input("🎼 Utiliser un piano classique pour cette entreprise ? (o/n) : ").strip().lower()
    if user_choice == "o":
        print("🎹 Piano classique sélectionné.")
        return 0  # Piano acoustique
    else:
        print("🎭 Attribution d'un instrument selon l'âge de l'entreprise.")
